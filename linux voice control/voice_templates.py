...
_TEMPLATES_DIR = pathlib.Path(os.getenv("XDG_CONFIG_HOME", "~/.config")).expanduser() / "Echo" / "templates"

# â”€â”€ Audio / feature parameters â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
_SR        = 16000
_N_MFCC    = 13
_N_MEL     = 26
...
# Adaptive threshold: accept if query distance â‰¤ mean-pairwise-spread Ã— factor
THRESHOLD_FACTOR   = 1.2
# Minimum RMS amplitude (0.0â€“1.0 normalised) for template matching to run.
# Real speech is typically 0.05â€“0.3; PC fan / background noise is < 0.02.
...
_templates: dict[str, list[np.ndarray]] = {}   # spoken_name â†’ [mfcc, ...]
...
def match(audio_bytes: bytes,
    ...
    voice samples were â€” tight samples â†’ tight threshold, variable samples
    â†’ looser threshold.
    ...
    for name, tmpl_list in _templates.items():
        ...
        # Ã— THRESHOLD_FACTOR.  Fall back to DEFAULT_THRESHOLD if only 1 sample.
        if len(valid) >= 2:
            pairs = []
...
# â”€â”€ MFCC computation (pure numpy, no scipy) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _compute_mfcc(audio_bytes: bytes) -> np.ndarray | None:
    ...
    try:
        ...
        # 0.05 â€“ 0.3.  This prevents the matcher from firing on ambient noise.
...
# â”€â”€ DTW â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _dtw_distance(a: np.ndarray, b: np.ndarray) -> float:
    ...
    # Accumulation (Python loop is fine â€” frames are short after capping)
